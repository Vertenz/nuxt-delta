      ...
      <v-row align="center" justify="center">
        <div>
          Наш эксперт приедет на место ДТП в течение 30 минут<span class="alert"
            >*</span
          >
          с момента заказа услуги. Окажет консультацию по способу оформления ДТП
          (с участием ГИБДД или Европротокол). В зависимости от способа
          оформления ДТП подскажет порядок действий по процедуре оформления ДТП
          (схема, Извещение, составление документов сотрудниками ГИБДД).
          Подскажет порядок обращения в страховую компанию. Составит и заполнит
          Протокол оформления ДТП, в котором указываются все сведения,
          необходимые и достаточные для оформления ДТП сотрудники ГИБДД, для
          доказательства наличия ДТП и страхового случая, для определения
          ответственного за ДТП, осуществит фотографирование транспортных
          средств, места ДТП.
          <div class="alert">
            * Интервал приезда эксперта может меняться в зависимости от дорожной
            обстановки.
          </div>
        </div>
      </v-row>
